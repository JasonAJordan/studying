...
int main() {
  ...
  cout << &bar[0] << "\t" << "NULL" <<"\t\t" << "bar[0]\n";
  cout << &bar[49] << "\t" << "NULL" <<"\t\t" << "bar[49]\n\n";
  ...
  /* Question 4
    ...
    17 is not divisible by 4 bytes. Which means the pointer can't access 305 (16) or 306 (20) giving us another memory value.
  */
  ...
  *(p +  8 * (100 + 1 + 10) + 100) = 947; cout << bar[8].var1 << "\n"; 
  ...
  int test2 = 420;
  cout << &test1 << " " << &test2 <<" \n";
  // The values go down in memory. You can see this with any of the variables created within the program. 0x62a680 < 0x62a67c
}